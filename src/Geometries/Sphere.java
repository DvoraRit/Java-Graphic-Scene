...
public Sphere(double radius, Point3D p,Color color) {//parameter constructor 
	super(color);
	this.radius = radius;
	this.p = p;
...
public void setP(Point3D p) {
	...
	public Vector getNormal(Point3D point) throws Exception {//this function return the normal vector in a specific point
		...
		/*Point3D temp1=new Point3D(p);
		temp1.substract(new Vector(new Point3D(point)));//the normal it's the vector from the point of the sphere and the point the function get
