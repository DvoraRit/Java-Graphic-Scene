...
public class finalProject2 {
	...
	public void Final() throws Exception {
		...
		//Shadow Panda
		Sphere shadowPanda = new Sphere(40, new Point3D(new Coordinate(-40), new Coordinate(-20), new Coordinate(-121)), 
		new Color(0,0,0), new Material(1,1,1));
		...
		Triangle grass2 = new Triangle(new Point3D(new Coordinate(-20), new Coordinate(-61),new Coordinate( -40)),
				new Point3D(new Coordinate(-22.5),new Coordinate(-75), new Coordinate(-40)),
				new Point3D(new Coordinate(-25),new Coordinate(-75),new Coordinate(-40)),
				new Color (0, 100, 0),new Material(1,1,1));
		Triangle grass3 = new Triangle(new Point3D(new Coordinate(-16), new Coordinate(-76),new Coordinate(-40)),
				new Point3D(new Coordinate(-19),new Coordinate(-90), new Coordinate(-40)),
				new Point3D(new Coordinate(-17),new Coordinate(-90),new Coordinate(-40)),
				new Color (0, 100, 0),new Material(1,1,1));
		Triangle grass4 = new Triangle(new Point3D(new Coordinate(-29), new Coordinate(-75),new Coordinate(-40)),
				new Point3D(new Coordinate(-33),new Coordinate(-89), new Coordinate(-40)),
				new Point3D(new Coordinate(-31.5),new Coordinate(-89),new Coordinate(-40)),
				new Color (0, 100, 0),new Material(1,1,1));
		Triangle grass5 = new Triangle(new Point3D(new Coordinate(-26), new Coordinate(-86),new Coordinate(-40)),
				new Point3D(new Coordinate(-30),new Coordinate(-100), new Coordinate(-40)),
				new Point3D(new Coordinate(-28.5),new Coordinate(-100),new Coordinate(-40)),
				new Color (0, 100, 0),new Material(1,1,1));
		Triangle grass6 = new Triangle(new Point3D(new Coordinate(-32), new Coordinate(-61),new Coordinate( -40)),
				new Point3D(new Coordinate(-34.5),new Coordinate(-75), new Coordinate(-40)),
				new Point3D(new Coordinate(-36),new Coordinate(-75),new Coordinate(-40)),
				new Color (0, 100, 0),new Material(1,1,1));
		Triangle grass7 = new Triangle(new Point3D(new Coordinate(-38), new Coordinate(-65),new Coordinate( -40)),
				new Point3D(new Coordinate(-40.5),new Coordinate(-79), new Coordinate(-40)),
				new Point3D(new Coordinate(-42),new Coordinate(-79),new Coordinate(-40)),
				new Color (0, 100, 0),new Material(1,1,1));
		Triangle grass8 = new Triangle(new Point3D(new Coordinate(-45), new Coordinate(-63),new Coordinate( -40)),
				new Point3D(new Coordinate(-47.5),new Coordinate(-77), new Coordinate(-40)),
				new Point3D(new Coordinate(-50),new Coordinate(-77),new Coordinate(-40)),
				new Color (0, 100, 0),new Material(1,1,1));
		Triangle grass9 = new Triangle(new Point3D(new Coordinate(-52), new Coordinate(-66),new Coordinate(-40)),
				new Point3D(new Coordinate(-54.5),new Coordinate(-80), new Coordinate(-40)),
				new Point3D(new Coordinate(-56),new Coordinate(-80),new Coordinate(-40)),
				new Color (0, 100, 0),new Material(1,1,1));
		Triangle grass10 = new Triangle(new Point3D(new Coordinate(-58), new Coordinate(-61),new Coordinate(-40)),
				new Point3D(new Coordinate(-59.5),new Coordinate(-75), new Coordinate(-40)),
				new Point3D(new Coordinate(-61),new Coordinate(-75),new Coordinate(-40)),
				new Color (0, 100, 0),new Material(1,1,1));
		Triangle grass11 = new Triangle(new Point3D(new Coordinate(-32), new Coordinate(-66),new Coordinate( -40)),
				new Point3D(new Coordinate(-34.5),new Coordinate(-80), new Coordinate(-40)),
				new Point3D(new Coordinate(-36),new Coordinate(-80),new Coordinate(-40)),
				new Color (0, 100, 0),new Material(1,1,1));
		Triangle grass12 = new Triangle(new Point3D(new Coordinate(-38), new Coordinate(-69),new Coordinate( -40)),
				new Point3D(new Coordinate(-40.5),new Coordinate(-83), new Coordinate(-40)),
				new Point3D(new Coordinate(-42),new Coordinate(-83),new Coordinate(-40)),
				new Color (0, 100, 0),new Material(1,1,1));
		Triangle grass13 = new Triangle(new Point3D(new Coordinate(-45), new Coordinate(-71),new Coordinate( -40)),
				new Point3D(new Coordinate(-47.5),new Coordinate(-85), new Coordinate(-40)),
				new Point3D(new Coordinate(-50),new Coordinate(-85),new Coordinate(-40)),
				new Color (0, 100, 0),new Material(1,1,1));
		Triangle grass14 = new Triangle(new Point3D(new Coordinate(-52), new Coordinate(-73),new Coordinate(-40)),
				new Point3D(new Coordinate(-54.5),new Coordinate(-87), new Coordinate(-40)),
				new Point3D(new Coordinate(-56),new Coordinate(-87),new Coordinate(-40)),
				new Color (0, 100, 0),new Material(1,1,1));
		Triangle grass15 = new Triangle(new Point3D(new Coordinate(-58), new Coordinate(-75),new Coordinate(-40)),
				new Point3D(new Coordinate(-59.5),new Coordinate(-89), new Coordinate(-40)),
				new Point3D(new Coordinate(-61),new Coordinate(-89),new Coordinate(-40)),
				new Color (0, 100, 0),new Material(1,1,1));
		...
		scene.addGeometry(grass6);
		scene.addGeometry(grass7);
		scene.addGeometry(grass8);
		scene.addGeometry(grass9);
		scene.addGeometry(grass10);
		scene.addGeometry(grass11);
		scene.addGeometry(grass12);
		scene.addGeometry(grass12);
		scene.addGeometry(grass13);
		scene.addGeometry(grass14);
		scene.addGeometry(grass15);
	...
	//	scene.addLight(new DirectionalLight(new Vector (new Point3D(new Coordinate(-70000),new Coordinate(10000), new Coordinate(-1000))) ,
		...
		//scene.addLight(new PointLight( new Point3D(new Coordinate(400),new Coordinate(400),new Coordinate(-250)), 0, 0.0001, 0.00005, 
			//	   new Color(255, 255, 153)));
		scene.addLight(new PointLight( new Point3D(new Coordinate(200),new Coordinate(800),new Coordinate(-200)), 
				   0, 0.0001, 0.000009,new Color(255,255,153)));
		...
		ImageWriter imageWriter = new ImageWriter("Final Project1", 500, 500, 500, 500);
