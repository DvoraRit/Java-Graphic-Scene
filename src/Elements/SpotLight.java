...
// ***************** Constructors ********************** //
	...
	public SpotLight(SpotLight l)  // copy
	{
		super(l);
	...
	@Override
	public String toString() {return "SpotLight: direction=" + direction;}
	
	@Override
	public Color getIntensity(Point3D point) throws Exception 
	{
		double d=point.distance(position);//d=point-position (dostance)
		...
		return c;
		//return new Color((int)tmp*color.getRGB());//color*(D*L)/(kc+kl*d+kq_d^2)
	}
	
	private Color scaleColor(Color color, double n) 
	//this function returns the result of scale*colors
