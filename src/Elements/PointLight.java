...
{
	protected Point3D position; //center light
	// גמספרים ממשים המייצגים את גורמי ההנחתה עם המרחק - הדלילות של האור 
	protected double kc; 
	protected double kl;
	protected double kq;
	...
	{
		double d=point.distance(position); //d=point-position (distance)
		//tmp= intensity, must be between 0 to 1
